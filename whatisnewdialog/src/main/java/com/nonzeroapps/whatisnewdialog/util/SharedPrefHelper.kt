...
object SharedPrefHelper {
    ...
    private fun getPreferencesEditor(context: Context): SharedPreferences.Editor = getPreferences(context).edit()
    ...
    fun isSeenBefore(
        context: Context,
        versionName: String,
    ): Boolean = getPreferences(context).getBoolean(versionName, false)
}
